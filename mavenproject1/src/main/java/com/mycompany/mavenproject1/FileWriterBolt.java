...
//        checks whether coming tuple is from DetailsExtractorBolt or RetweetDetailsExtractorBolt.
    ...
    public void prepare(Map arg0, TopologyContext arg1,
        ...
        try {
            ...
            sb.append("user_name" + " , " + "tweets");
            sb.append("\n");
            fileWriter.write(sb.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
           //"screen_name" + "," + "user_name" + "," + "status_id"
    ...
    /**
     * @param uniqueId
     * This method writes detaistls in to file if all the tuples processed from the both bolts.
     */
            ...
            if (fileDetails.isWritable()) {
                try {
                    BufferedWriter bufferedWriter = new BufferedWriter(
                            fileWriter);
                    System.out.println("Tweet :: "+fileDetails.toString());
